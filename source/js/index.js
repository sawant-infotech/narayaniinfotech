...
function readComments() {
    commentData = [
        ...
        ["", "Abhjit Borude", "I recently purchased a second hand desktop from Narayani Infotech and I couldn't be happier with my purchase. The team at the company was incredibly helpful in assisting me with my decision and the desktop itself has been running smoothly since I received it. I am very satisfied with my experience with Narayani Infotech and highly recommend them to anyone in need of a new or second hand desktop.", 5],
        ["", "Ajinkya Sutar", "As an active trader, having a reliable and efficient setup is crucial to my success. Narayani Infotech did an excellent job in helping me create the perfect multi-screen setup for my needs. The team was knowledgeable and professional, and the final result exceeded my expectations. I am extremely satisfied with my experience with Narayani Infotech and would highly recommend them to anyone in need of a share market setup.", 4]
    ];
    return commentData;
}
// display comments
